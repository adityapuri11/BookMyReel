...
const sendBookingConfirmationEmail = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    if (!booking.user) {
      console.error(`No user found for booking ${bookingId}`);
      return; 
    }
    ...
    await sendEmail({
      ...
      body: `
        <div style="font-family: Arial, sans-serif; line-height: 1.5;">
          ...
          <p>Enjoy the show! 🍿</p>
          <p>Thanks for booking with us!<br/>— BookMyReel Team</p>
          <p>Anshul Choudhary <br/> Hritvik Sharma <br/> Jigyasa Arora <br/> Aditya Thakur<p>
        </div>`
    });
  }
);
